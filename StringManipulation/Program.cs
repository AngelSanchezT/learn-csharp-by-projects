...
internal class Program
{
    static void Main(string[] args)
    {
        ...
        //8. Reemplazo
        string reemmplazada = cadena1.Replace("Hola", "Adios");
        Console.WriteLine($"Reemplazo: {reemmplazada}");
        ...
        Console.WriteLine($"¿Cadena2 empieza con 'C#'? {cadena2.StartsWith("C#")}");
        Console.WriteLine($"¿Cadena2 termina con 'genial'? {cadena2.Trim().EndsWith("genial")}");
